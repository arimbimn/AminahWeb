        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="/login" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" id="password" class="form-control" placeholder="masukkan kata sandi/password anda">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <p class="mb-1">
                        ...
                        <a href="forgot-password.html">Klik Disini</a>
                    </p>
                    <div class="row">
                        <div class="col-8">
