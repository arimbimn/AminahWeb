            ...
            <div class="card-body login-card-body">
                ...
                <form action="/login" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" id="email" class="form-control" placeholder="masukkan e-mail atau nomor telepon anda">
                    ...
                    <p class="mb-1">
                        ...
                        <a href="/lupapassword">Klik Disini</a>
                    </p>
                    <div class="row">
                        <div class="col-8">
                ...
                <p class="mb-0">
                    Belum Punya Akun?
                    <a href="/registerLender" class="text-center">Daftar Disini</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
