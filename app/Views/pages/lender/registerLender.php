...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/Aminah1.png" rel="icon">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="/registerLender" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" id="password" class="form-control" placeholder="masukkan kata sandi/password kamu disini">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <label for="password">Masukkan Ulang Kata Sandi/Password</label>
                    <div class="input-group mb-3">
                        <input type="password" name="password" id="password" class="form-control" placeholder="masukkan ulang kata sandi/password kamu disini">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                            </div>
